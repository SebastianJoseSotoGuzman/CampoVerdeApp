<%@page import="com.cv.model.entity.Conductor"%>
<%@page import="com.cv.DAO.ConductorDAO"%>
<%@page import="com.cv.model.entity.Vehiculo"%>
<%@page import="com.cv.DAO.VehiculoDAO"%>
<%@page import="com.cv.model.entity.Transporte"%>
<%@page import="com.cv.DAO.TransporteDAO"%>
<%@page import="com.cv.DAO.ProductoDAO"%>
<%@page import="com.cv.DAO.AuxiliarDAO"%>
<%@page import="com.cv.DAO.UnidadVentaDAO"%>
<%@page import="com.cv.model.entity.DetalleMovimiento"%>
<%@page import="com.cv.model.entity.Motivo"%>
<%@page import="com.cv.DAO.MotivoDAO"%>
<%@page import="com.cv.DAO.MovimientoDAO"%>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            ...
                                            <div class="d-flex">
                                                ...
                                                <div class="col-sm-2">
                                                    <input class="form-control form-control-sm" name="txtSerie" value="GR02" readonly="">
                                                </div>
                                                <div class="col-sm-3">
                                            ...
                                            <div class="d-flex">
                                                <label class="col-sm-3 col-form-label" style="text-align:right">Receptor:</label>
                                                <div class="col-sm-9">
                                                    <div class="input-group input-group-sm">
                                                        <input type="hidden" name="txtIdcli" value="<%=objClienteGRC.getIdauxiliar() == 0 ? "" : objClienteGRC.getIdauxiliar()%>" class="form-control">
                                                        <input type="text" name="txtNombre" value=" <%=objClienteGRC.getNombre()%>" class="form-control">
                                            ...
                                            <div class="d-flex">
                                                ...
                                                <div class="col-sm-9">
                                                    <input class="form-control form-control-sm" name="txtI" value="<%=objClienteGRC.getNumerodocumento()%>">
                                                </div>
                                            </div>
                                            <div class="d-flex">
                                                <label class="col-sm-3 col-form-label" style="text-align:right">Transporte:</label>
                                                <div class="col-sm-4">
                                                    <select name="txtTransporte" id="txtTransporte" required="" class="form-control form-control-sm">
                                                        ...
                                                        <% TransporteDAO t = new TransporteDAO();
                                                            ...
                                                            while (ittt.hasNext()) {
                                                                tr = ittt.next();
                                                        %>
                                                        <option  value="<%=tr.getIdtrans()%>" required><%=tr.getNombre()%></option>
                                                        <%
                                                            }
                                                        %>
                                                    </select> 
                                                </div>
                                                <label class="col-sm-2 col-form-label" style="text-align:right">Vehículo:</label>
                                                <div class="col-sm-3">
                                                    <select name="txtVehiculo" id="txtTransporte" required="" class="form-control form-control-sm">
                                                        <option   value=""disabled="" selected=""></option>
                                                        <% VehiculoDAO v = new VehiculoDAO();
                                                            ...
                                                            while (itv.hasNext()) {
                                                                tvr = itv.next();
                                                        %>
                                                        <option  value="<%=tvr.getIdvehi()%>" required><%=tvr.getPlaca()%></option>
                                                        <%
                                                            }
                                                        %>
                                                    </select> 
                                            ...
                                            <div class="d-flex">
                                                ...
                                                <label class="col-sm-3 col-form-label" style="text-align:right">Conductor:</label>
                                                <div class="col-sm-9">
                                                    <select name="txtConductor" id="txtTransporte" required="" class="form-control form-control-sm">
                                                        <option   value=""disabled="" selected=""></option>
                                                        <% ConductorDAO tc = new ConductorDAO();
                                                            ...
                                                            while (ittc.hasNext()) {
                                                                trc = ittc.next();
                                                        %>
                                                        <option  value="<%=trc.getIdcond()%>" required><%=trc.getChofer()%></option>
                                                        <%
                                                            }
                                                        %>
                                                    </select> 
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="d-flex">
                                                <label class="col-sm-3 col-form-label" style="text-align:right">Punto de Partida:</label>
                                                <div class="col-sm-9">
                                                    <input type="text" name="txtCondicion" value="Jr. Ancash Nrp. 919 int. 9 Lima - Lima - Lima" class="form-control form-control-sm" >
                                                </div>
                                            </div>
                                            <div class="d-flex">
                                                <label class="col-sm-3 col-form-label" style="text-align:right">Punto de llegada:</label>
                                                <div class="col-sm-9">
                                                    <input class="form-control form-control-sm" type="text" name="txtdirecc" value="<%=objClienteGRC.getDireccion()%>">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="card-body">
                                        <div class="row">
                                                    ...
                                                    <table width="100% " class="table_fill table-striped">
                                                        ...
                                                        <tbody>
                                                            <tr>
                                                                ...
                                                                <td style="width:4px;">
                                                                    <input  class="form-control form-control-sm" style="width :110px; text-align:center;"  value="<%=String.format("%.2f", ni.getCantidad())%>" placeholder="1.00" step="0.01" min="0.01" max="<%=ProductoDAO.getValidarstock(ni.getIdproducto())%>" id="txtPro_cantidad<%=fila%>" name="txtPro_cantidad"  onchange="actualizarcantidad(<%= fila%>)" required>
                                                                </td>
                                            ...
                                            <div  class="col-md-1">
                                                <div class="d-flex">
                                                    <div class="col-sm-12">
                                                        <a class="btn btn-secondary" style="margin-bottom:5px; margin-top: 14px;" href="ProductosActivosguiaremisioncliente.jsp">NUEVO</a> 
                                                    </div>
                                                </div>
                                                <div class="d-flex">
                                                    <div class="col-sm-12">
                                                        <a class="btn btn-secondary" style="margin-bottom:5px;" href="GuiaremisionclienteController?accion=Limpiargrc">Limpiar</a> 
                                                    </div>
                                                </div>                                     
                                                <div class="d-flex">
                                                    <div class="col-sm-12">
                                                        <a class="btn btn-primary" style="margin-bottom:5px;" href="ListarGuiaremisioncliente.jsp" role="button">Salir</a>
                                                    </div>
                                                </div>
                                                <div class="d-flex">
                                                    <div class="col-sm-12">
                                                        <input class="btn btn-success" style="margin-bottom:5px;" type="submit" value="Grabar" name="btnVenta"> 
                                                    </div>
                                                </div>
                                            </div>            
                                        </div>
                                        ...
                                        <tbody >
                                            ...
                                            <tr>
                                                ...
                                                <td style="width:8%">
                                                    ...
                                                    <a  href="ClienteController?accion=BuscarPorIdGRC&idClientegrc=<%=p.getIdauxiliar()%>" ><i class="glyphicon glyphicon-plus-sign" style="color: #09bb04" data-toggle="tooltip" title="agregar"></i></a>
                                                </td>
                                                <td ><%=p.getCodigo()%></td>
                                                <td><%=p.getNombre()%></td>
