                                        ...
                                        <table width="100% " class="table_fill table-striped">
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td style="width:4px;">
                                                        <input  class="form-control form-control-sm" style="width :110px; text-align:center;" value="<%=String.format("%.2f", ni.getCantidad())%>" placeholder="1.00" step="0.01" min="0.01" max="<%=ProductoDAO.getValidarstock(ni.getIdproducto())%>" id="txtPro_cantidad<%=fila%>" name="txtPro_cantidad"  onchange="Ventaactualizarcantidad(<%= fila%>)" required>
                                                    </td>
