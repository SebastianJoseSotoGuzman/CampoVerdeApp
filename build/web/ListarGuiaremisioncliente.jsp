...
<html>
    <head>
        ...
        <title>Guia de Remision Plastitex"</title>
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="card card-default">
                                <div class="card-header">
                                    <h3 class="card-title" style="color: white;">GUÍA DE REMISIÓN</h3>
                                        ...
                                        <div class="form-group col-md-2">
                                            ...
                                            <select class="form-control select2" name="cbDocu" id="cbDoc" required="" disabled="true"
                                                ...
                                                <% MovimientoDAO vddao = new MovimientoDAO();
                                                    List<Movimiento> vdlist = vddao.ListadoGuiaremisioncliente();
