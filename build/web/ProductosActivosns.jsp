                                                ...
                                                <table id="B" class="table table-striped table-bordered table-sm " cellspacing="0"
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td style="width:5px">
                                                                <a  href="ControllerdatosModal?accion=Cantidadns&id=<%=pro.getIdproducto()%>"  data-toggle="modal" data-target="#myModalEdit"><i class="glyphicon glyphicon-plus-sign" style="color: #09bb04" data-toggle="tooltip" title="agregar"></i></a>
                                                            </td>
                                                            <td><%=pro.getCodigo()%></td>
