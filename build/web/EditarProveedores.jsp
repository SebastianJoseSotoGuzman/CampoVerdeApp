                        ...
                        <div class="col-12">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <br>
                                    <form id="editproveedor" action="ProveedorController" method="Post" name="frm_edit">
                                        <div class="row">
                                                ...
                                                <fieldset>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-lg-11 col-md-8 col-sm-12 col-xs-12">
                                                            <input type="text" name="Txtapellidos" onkeypress="return soloLetras(event)" value="<%=cl.getNombre()%>" class="border-focus-darkblue form-control">
                                                            <span class="help-block"></span>
                                                        </div>
                                                    </div>
                                                    <div class="form-group">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-lg-11 col-md-8 col-sm-12 col-xs-12">
                                                            <input type="text" name="Txtnumerodocumento" onkeypress="return soloNumeros(event)" value="<%= cl.getNumerodocumento()%>" maxlength="11" id="cedula" class="border-focus-darkblue form-control">
                                                            <span class="help-block"></span>
                                                        </div>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-lg-11 col-md-8 col-sm-12 col-xs-12">
                                                            <input type="text" name="Txtdireccion" value="<%= cl.getDireccion()%>" id="Txtdireccion" class="border-focus-darkblue form-control">
                                                            <span class="help-block"></span>
                                                        </div>
                                                    </div>
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-lg-11 col-md-8 col-sm-12 col-xs-12">
                                                            <input type="text" name="Txtcorreo" value="<%= cl.getCorreo()%>" id="Txtcorreo" class="border-focus-darkblue form-control">
                                                            <span class="help-block"></span>
                                                        </div>
                                                    </div>
                                                </fieldset>
                                            ...
                                            <div class="col-lg-6 col-md-12 col-sm-12 col-xs-12">
                                                <fieldset>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-lg-11 col-md-8 col-sm-12 col-xs-12">
                                                            <input type="text" name="Txtfechaderegistro" value="<%=cl.getFechaderegistro()%>" class="border-focus-darkblue form-control">
                                                            <span class="help-block"></span>
                                                        </div>
                                                    </div>
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-lg-11 col-md-8 col-sm-12 col-xs-12">
                                                            <input type="text" name="Txtcontacto" value="<%=cl.getContacto()%>" class="border-focus-darkblue form-control">
                                                            <span class="help-block"></span>
                                                        </div>
                                                    </div>
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-lg-11 col-md-8 col-sm-12 col-xs-12">
                                                            <input type="text" name="Txttelefono" onkeypress="return soloNumeros(event)" class="border-focus-darkblue form-control">
                                                            <span class="help-block"></span>
                                                        </div>
                                                    </div>
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-lg-11 col-md-8 col-sm-12 col-xs-12">
                                                            <input type="text" name="Txtcelular" value="<%= cl.getCelular()%>" onkeypress="return soloNumeros(event)"  id="Txtcelular" class="border-focus-darkblue form-control">
                                                            <span class="help-block"></span>
                                                        </div>
                                                    </div>
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-lg-11 col-md-8 col-sm-12 col-xs-12" class="border-focus-darkblue form-control">
                                                            ...
                                                            &nbsp;&nbsp;&nbsp;<input  type="radio" name="Txtsexo" value="M" checked="checked">&nbsp;M
                                                            <% } else { %>
                                        ...
                                        <div class="modal-footer"> 
                                            <center>
                                                ...
                                                <button onclick="return validareditproveedores()" type="submit" name="accion" class="btn btn-app bg-cyan" ><i class="fas fa-check-square"></i> ACTUALIZAR</button>
                                            </center>
                                        </div>
                                    </form>
                                </div>
