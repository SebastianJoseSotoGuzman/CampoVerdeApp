...
<html>
    <head>
        ...
        <title>Nota de Salida Plastitex"</title>
                    ...
                    <div class="row mb-2">
                        ...
                        <div class="col-sm-12">
                            <ol class="breadcrumb float-sm-right">
                                <a href="InsertarNotadeSalida.jsp" style="height: 30px;display: inline-block;margin-bottom: 0;font-weight: bold;text-align: center;vertical-align: middle;letter-spacing: 1px;text-transform: uppercase;-ms-touch-action: manipulation;touch-action: manipulation;cursor: pointer;transition: all 0.2s;background-image: none;border: 2px solid transparent;white-space: nowrap;padding: 2px 18px;font-size: 12px;line-height: 1.78571;border-radius: 20px;-webkit-user-select: none;-ms-user-select: none;user-select: none;padding-top: 3px;" class="bluefacturactivaFocus js-customer-action-add btn-primary"><i class="fas fa-folder-plus"></i> &nbsp; NUEVO</a>
                            </ol>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="card card-default">
                                <div class="card-header">
                                    <h3 class="card-title" style="color: white;">Nota de Salida</h3>
                                    ...
                                    <div class="row">
                                        <div class="form-group col-md-3">
                                            ...
                                            <input type="radio" value="" id="rbCli" name = "cliente" onclick="
                                                   ...
                                                   ">
                                            <label style="text-align:right">Cliente:</label>
                                            <select class="form-control select2" name="cbCliente" id="cbCli" required="" disabled="true"
                                                ...
                                                <%  AuxiliarDAO pdao = new AuxiliarDAO();
                                                    List<Auxiliar> prov = pdao.ListadoCliente();
                                        ...
                                        <div class="form-group col-md-2">
                                            ...
                                            <select class="form-control select2" name="cbDocu" id="cbDoc" required="" disabled="true"
                                                ...
                                                <% MovimientoDAO vddao = new MovimientoDAO();
                                                    List<Movimiento> vdlist = vddao.ListadoNotaSalidaNS();
                                        ...
                                        <table id="B" class="table table-striped table-bordered second" style="width:100%">
                                            ...
                                            <tbody>
                                                <%  MovimientoDAO vdao = new MovimientoDAO();
                                                    List<Movimiento> vlist = vdao.ListadoNotaSalidaNS();
                                            ...
                                            <td>
                                                ...
                                                <%     }
                                                %>
                                                <a href="DetallePDFController?accion=DetalleNS&id=<%= vent.getIdmovimiento()%>" class="btn-sm btn-success" >Detalle</a>
                                            </td>
                                            <%
                                                }
                                            %>
