    ...
    <body>
        ...
        <div >
            <%
                ...
                int id = Integer.parseInt((String) request.getAttribute("idproxalmni"));
            ...
            <div class="modal-content">
                ...
                <form method="post" action="NotadeIngresoController" accion="AnadirCarritoni"> 
                    ...
                    <div class="modal-footer">
                        <a href="ProductosActivosni.jsp" class="btn btn-default" >Cancelar</a> 
                        <input type="submit" value="Añadir" class="btn btn-success" name="btnAnadir">
                        <input type="hidden" name="accion" value="AnadirCarritoni"/>
                    </div>
                </form>
            </div>
        </div>
