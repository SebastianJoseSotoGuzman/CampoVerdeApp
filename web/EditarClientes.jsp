                                    ...
                                    <form id="editcliente" action="ClienteController" method="Post" name="frm_edit">
                                            ...
                                            <div class="col-lg-6 col-md-12 col-sm-12 col-xs-12">
                                                <fieldset>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-lg-11 col-md-8 col-sm-12 col-xs-12">
                                                            <input type="text" name="Txttelefono" value="<%= cl.getTelefono()%>" onkeypress="return soloNumeros(event)" id="Txttelefono" class="border-focus-darkblue form-control">
                                                            <span class="help-block"></span>
                                                        </div>
                                                    </div>
                                                    <div class="form-group">
                                        ...
                                        <div class="modal-footer"> 
                                            <center>
                                                ...
                                                <button onclick="return validareditclientes()" type="submit" name="accion" class="btn btn-app bg-cyan" ><i class="fas fa-check-square"></i> ACTUALIZAR</button>
                                            </center>
                                        </div>
                                    </form>
                                </div>
