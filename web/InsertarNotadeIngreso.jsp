...
<html lang="en">
    <head>
        ...
        <title>Registrar Nota de Ingreso</title>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            ...
                                            <div class="d-flex">
                                                ...
                                                <div class="col-sm-9">
                                                    <div class="input-group input-group-sm">
                                                        <input type="hidden" name="txtIdcli" value="<%=objProvedorNI.getIdauxiliar() == 0 ? "" : objProvedorNI.getIdauxiliar()%>" class="form-control">
                                                        <input type="text" name="txtNombre" value=" <%=objProvedorNI.getNombre()%>" class="form-control">
                                            ...
                                            <div class="d-flex">
                                                ...
                                                <div class="col-sm-9">
                                                    <input class="form-control form-control-sm" name="txtI" value="<%=objProvedorNI.getNumerodocumento()%>">
                                                </div>
                                            </div>
                                            <div class="d-flex">
                                                <label class="col-sm-3 col-form-label" style="text-align:right">Correo Receptor:</label>
                                                <div class="col-sm-9">
                                                    <input class="form-control form-control-sm" name="txtcorreo" value="<%=objProvedorNI.getCorreo()%>">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            ...
                                            <div class="d-flex">
                                                ...
                                                <div class="col-sm-9">
                                                    <input class="form-control form-control-sm" type="text" name="txtdirecc" value="<%=objProvedorNI.getDireccion()%>">
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td style="width:500px;">
                                                     ...
                                                     <td  style="width:5px;">
                                                        <input  class="form-control form-control-sm" style="width :110px; text-align:center;" value="<%=String.format("%.2f", ni.getCantidad())%>" placeholder="1.00" step="0.01" min="0.01" id="txtPro_cantidad<%=fila%>" name="txtPro_cantidad"  onchange="Ventaactualizarcantidad(<%= fila%>)" required>
                                                    </td>
                                                    <td style="width:4px;">
                                        ...
                                        <div class="col-md-2">
                                            <div class="card-body">
                                                <div class="form-group row"> 
                                                    ...
                                                    <a class="btn btn-primary float-right" href="ListarNotaingreso.jsp" role="button">Salir</a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <tbody >
                                            ...
                                            <tr>
                                                ...
                                                <td style="width:8%">
                                                    ...
                                                    <a  href="ProveedorController?accion=buscarPorIdNI&idProveedorNI=<%=p.getIdauxiliar()%>" ><i class="glyphicon glyphicon-plus-sign" style="color: #09bb04" data-toggle="tooltip" title="agregar"></i></a>
                                                </td>
                                                <td><%=p.getCodigo()%></td>
                                                <td><%=p.getNombre()%></td>
