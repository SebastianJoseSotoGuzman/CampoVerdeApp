    ...
    <body>
        ...
        <div >
            <%
                ...
                int id = Integer.parseInt((String) request.getAttribute("guiacliente"));
            ...
            <div class="modal-content">
                ...
                <form method="post" action="GuiaremisionclienteController" accion="AnadirCarritogrc"> 
                    ...
                    <div class="modal-footer">
                        <a href="ProductosActivosguiaremisioncliente.jsp" class="btn btn-default" >Cancelar</a> 
                        <input type="submit" value="Añadir" class="btn btn-success" name="btnAnadir">
                        <input type="hidden" name="accion" value="AnadirCarritogrc"/>
                    </div>
                </form>
            </div>
        </div>
