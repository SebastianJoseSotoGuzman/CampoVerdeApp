...
<html>
    <head>
        ...
        <title>REPORTE DE STOCK VALORIZADO</title>
                            ...
                            <div class="card card-default">
                                ...
                                <div class="card-body"> 
                                    <div class="row">
                                        ...
                                        <div class="form-group col-md-2">
                                            <input type="radio" value="" id="rbSub" name = "Sub" style="align-items: center" onclick="
                                                    cbSubc.disabled = false;

                                                   ">
                                            <label>SubCategoria:</label>
                                            <select class="form-control select2" name="cbSubc" id="cbSub" required="" disabled="true"
                                                    onchange="validaciones();
                                                            document.getElementById('selInfo').focus();">
                                                <option value ="" selected="" style="text-align: center">-Todos-</option>
                                        ...
                                        <div class="form-group col-md-4">
                                            ...
                                            <select class="form-control select2" name="cbCliente" id="cbCli" required="" disabled="true"
                                                ...
                                                <%  ProductoDAO pdao = new ProductoDAO();
                                                    List<Producto> prov = pdao.ListadoProducto();
                                        ...
                                        <table id="datatable" class="table table-striped table-bordered second" style="width:100%">
                                            ...
                                            <tbody>
                                                <%ProductoDAO pddao = new ProductoDAO();
                                                    List<Producto> listS = pddao.ListadoProducto();
                                                ...
                                                <tr>
                                                    ...
                                                    <td style="text-align: right;"><%=String.format("%.2f", pro.getPreciocompra())%></td>
                                                    <td style="text-align: right;"><%=String.format("%.2f", pro.getStock() * pro.getPreciocompra())%></td>
                                                </tr>
                                                <%}%>
