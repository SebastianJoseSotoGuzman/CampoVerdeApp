...
<%@page import="com.cv.model.entity.Producto"%>
                                ...
                                <div class="card-body">
                                    <table id="example"  class="table table-striped table-bordered second" style="width:100%">
                                        ...
                                        <td style="text-align: center">
                                            <a href="ProductoController?accion=editar&id=<%=pro.getIdproducto()%>" class="btn btn-warning editbtn"><i data-toggle="tooltip" title="Editar"><img src="img/modify.png"></i></a>
                                            <a id='btn-estado' class="btn btn-primary" class="edit"><i data-toggle="tooltip" title="Estado"><img src="img/estado.png"></i></a>
                                            <a href="ProductoController?accion=detalle&id=<%=pro.getIdproducto()%>" class="btn btn-success"><i data-toggle="tooltip" title="Detalle"><img src="img/vista.png"></i></a>
                                            <a id='btn-eliminar' class="btn btn-danger" class="edit"><i data-toggle="tooltip" title="Eliminar"><img src="img/delete.png"></i></a>
                                        </td>
                                        </tr>
                                        <%}%>
                                        </tbody>
